...
inventory updates. So you must either use the published reference EE or build
your own.
...
collection from a tarball at `ee/akeyless-awx_integration.tar.gz`. Build the
tarball before running `ansible-builder`:
...
> **Tip:** If your base image must come from an internal registry, edit
